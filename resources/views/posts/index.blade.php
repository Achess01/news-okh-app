                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="{{ route('posts.report', $post->id) }}" method="POST">
                                                @csrf
                                                <div class="mb-3">
                                                    <label for="reported_reason" class="form-label">Razón del reporte</label>
                                                    <textarea class="form-control" id="reported_reason" name="reported_reason" rows="3" required></textarea>
                                                </div>
